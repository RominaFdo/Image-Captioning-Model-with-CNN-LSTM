...
def load_photo_features(photos):
...
train_imgs = load_phots(filename)
train_descriptions = load_clean_descriptions('descriptions.txt', train_imgs)
train_features = load_photo_features(train_imgs)
